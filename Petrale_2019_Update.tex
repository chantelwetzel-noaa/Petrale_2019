...
each fleet are shown in Figures \ref{fig:discard_wn_len},
\ref{fig:discard_sn_len}, \ref{fig:discard_ws_len}, and
\ref{fig:discard_ss_len}.
...
\caption{Length comp data, discard, Winter (N) (max=0.63)
\label{fig:discard_wn_len}}
\end{figure}

\begin{figure}
\centering
\includegraphics{r4ss/plots_mod1/comp_lendat_bubflt2mkt1.png}
\caption{Length comp data, discard, Summer (N) (max=0.32)
\label{fig:discard_sn_len}}
\end{figure}

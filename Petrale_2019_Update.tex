...
\caption{Conditional AAL plot, whole catch, NWFSC West Coast Groundfish
Bottom Trawl Survey (plot 2 of 4) \label{fig:nwfsc_combo_andre_4}}
\end{figure}
...
\caption{Conditional AAL plot, whole catch, NWFSC West Coast Groundfish
Bottom Trawl Survey (plot 3 of 4) \label{fig:nwfsc_combo_andre_5}}
\end{figure}
...
\caption{Conditional AAL plot, whole catch, NWFSC West Coast Groundfish
Bottom Trawl Survey (plot 4 of 4) \label{fig:nwfsc_combo_andre_6}}
\end{figure}

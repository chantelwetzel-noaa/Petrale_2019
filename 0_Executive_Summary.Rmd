...
Additionally, to date a reconstructed historical Washington catch history has not been included in the `r spp` stock assessment.  Washington state is currently undergoing efforts to determine historical catches for `r spp` and next assessment is likely to incorporate these new historical catch estimates.  

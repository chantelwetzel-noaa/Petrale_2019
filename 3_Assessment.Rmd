...
\begin{enumerate}
  ...
  \item Estimate the sex ratio between female and male fish within the model and assume the coastwide fecundity relationship for `r spp` Lefebvre et al. in press.

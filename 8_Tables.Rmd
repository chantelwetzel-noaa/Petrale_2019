...
Sens_model1.table = xtable(Sens_model1, 
                           caption = c('Sensitivity runs relative to the base model.'),
...
Forecast_mod1.table = xtable(Forecast_mod1,
                             caption = c('Projections of potential OFL (mt) and ABC (mt) and the estimated spawning biomass and relative spawning biomass based on ABC removals.  The 2019 and 2020 removals are set at the harvest limits currently set by management of 2908 and 2845 mt per year, respectively.'),

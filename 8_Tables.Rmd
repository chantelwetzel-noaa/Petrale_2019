...
Fish_Length.table = xtable(Fish_Length, 
                           caption = c('Summary of NWFSC West Coast Groundfish Bottom Trawl Survey length samples used in the stock assessment.'),
...
# Index of abundance summary, create table   
Fish_Length.table = xtable(Fish_Length, 
                           caption = c('Summary of NWFSC West Coast Groundfish Bottom Trawl Survey age samples used in the stock assessment.'),
...
# Index of abundance summary, create table   
Fish_Length.table = xtable(Fish_Length, 
                           caption = c('Summary of AFSC/NWFSC West Coast Triennial Shelf Survey length samples used in the stock assessment.'),
...
# Index of abundance summary, create table   
Fish_Length.table = xtable(Fish_Length, 
                           caption = c('Summary of fishery length samples used in the stock assessment (continued on the next page).'),
